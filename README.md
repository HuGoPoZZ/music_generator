...
2. **Probabilités** — on transforme ces comptages en probabilités (une note qui suit souvent un couple donné aura plus de chances d'être choisie).
3. **Génération** — on part d'un couple de notes réel, et on tire au sort la suite en respectant les probabilités apprises, note après note, jusqu'à obtenir la longueur voulue.
...
Projet personnel d'apprentissage, libre d'utilisation et de modification.
